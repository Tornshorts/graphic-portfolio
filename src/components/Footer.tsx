        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-4 leading-relaxed">
              A passionate developer creating digital experiences that make a
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, idx) => (
                <a
                  ...
                  className={`w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 ${social.color} hover:bg-gray-700 transition-all duration-300`}
                  title={social.name}
                >
                  {social.icon}
                </a>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="mailto:kawewaalex@gmail.com"
                className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-200"
              >
                <EmailIcon />
                <span className="ml-2">kawewaalex@gmail.com</span>
              </a>
              <a
                href="tel:+254748511041"
                className="flex items-center text-gray-400 hover:text-green-400 transition-colors duration-200"
              >
                <PhoneIcon />
                <span className="ml-2">+254748511041</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-gray-400 text-sm text-center md:text-left">
              &copy; {currentYear} Alex Kawewa. All rights reserved.
            </div>
